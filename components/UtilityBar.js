...
// A small badge for the account switcher. Demo used to be a plain 🕹️
// emoji, which some Android browsers render as an ugly fallback glyph
// instead of an actual joystick. This SVG version always looks the same.
  ...
  if (type === 'demo') {
    return (
      ...
      >
        ...
        <circle cx="12" cy="7.4" r="2.2" fill="#04302b" />
        <rect x="10.5" y="8.8" width="3" height="5.6" rx="1.5" fill="#04302b" />
        <rect x="6.4" y="15.2" width="11.2" height="3.4" rx="1.7" fill="#04302b" />
      </svg>
    );
  }
  return (
