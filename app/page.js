...
export default function HomePage() {
  ...
  return (
    <div id="homepage" className="visible">
      ...
      {/* Same floating arrangement as the dashboard: risk badge bottom-left,
          AI button bottom-right. The homepage has no RUN bar, so these two
          sit at the bottom corners on their own. */}
      <button
        type="button"
